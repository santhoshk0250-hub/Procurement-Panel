...
import CommonServiceCard from "@/components/dashboard/CommonServiceCard";
                ...
                <CommonServiceCard
                  ...
                  topLeftChips={[
                    ...
                    ...(typeof a.rating === "number"
                      ? [{ icon: <StarIcon fontSize="small" />, label: `${a.rating} (${a.reviewCount ?? 0})` }]
                      : []),
                  ]}
                  topRightChips={[
                    { icon: <ImageIcon />, label: String(a.images?.length ?? 0) },
                    { icon: <OndemandVideo />, label: String(a.videos?.length ?? 0) },
                  ]}
                  description={desc}
                  metaChips={[
                    {
                    ...
                    ...(pickupLabel ? [{ icon: <RouteIcon fontSize="small" />, label: pickupLabel }] : []),
                  ]}
                  editHref="/dashboard/Activities/editactivities"
                  onEdit={() => handleEdit(a)}
                  onDelete={() => {
                    setSelected(a);
                    setConfirmOpen(true);
